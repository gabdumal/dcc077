...
MERGE (p1)-[:USES {start_time: "2022-10-02T08:00:00",
                   end_time: "2022-10-02T12:00:00", status: "broken"}]->
      (m1:Machine {serial_number: "AAA001"})
MERGE (p1)-[:USES {start_time: "2022-10-02T12:00:00",
                   end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p2)-[:USES {start_time: "2022-10-02T08:00:00",
                   end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p3)-[:USES {start_time: "2022-10-02T08:00:00",
                   end_time: "2022-10-02T10:00:00", status: "broken"}]->
      (m4:Machine {serial_number: "AAA004"})
MERGE (p3)-[:USES {start_time: "2022-10-02T10:00:00",
                   end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p4)-[:USES {start_time: "2022-10-02T08:00:00",
                   end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p5)-[:USES {start_time: "2022-10-02T08:00:00",
                   end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p6)-[:USES {start_time: "2022-10-02T08:00:00",
                   end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p7)-[:USES {start_time: "2022-10-02T08:00:00",
                   end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p8)-[:USES {start_time: "2022-10-02T08:00:00",
                   end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p9)-[:USES {start_time: "2022-10-02T08:00:00",
                   end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p10)-[:USES {start_time: "2022-10-02T08:00:00",
                    end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p11)-[:USES {start_time: "2022-10-02T08:00:00",
                    end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p12)-[:USES {start_time: "2022-10-02T08:00:00",
                    end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p13)-[:USES {start_time: "2022-10-02T08:00:00",
                    end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p14)-[:USES {start_time: "2022-10-02T08:00:00",
                    end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p15)-[:USES {start_time: "2022-10-02T08:00:00",
                    end_time: "2022-10-02T17:00:00", status: "active"}]->
...
MERGE (p16)-[:USES {start_time: "2022-10-02T08:00:00",
                    end_time: "2022-10-02T17:00:00", status: "active"}]->
